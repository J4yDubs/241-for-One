...
**************************************************
4. LIST OF KEY COMMANDS
**************************************************
4.1 When entering matrix values (inside matrix entry text box):
 - Arrow keys ('Up', 'Down', 'Left', 'Right') to navigate between entry boxes

4.2 When viewing calculation steps
- - Arrow keys ('Up', 'Down')  to scroll


**************************************************
5. LIST OF SHORTCUT COMMANDS
**************************************************
None.
